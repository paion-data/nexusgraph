...
const DEFAULT_COLORS: DefaultColorType[] = [
  ...
  {
    color: "rgba(180, 200, 224)",
    "border-color": "rgba(200, 200, 224, 0.8)",
    "text-color-internal": "#FFFFFF",
  },
  {
    color: "rgba(139, 191, 248, 0.9)",
    "border-color": "rgba(168, 208, 250, 0.7)",
    "text-color-internal": "#FFFFFF",
  },
  {
    color: "rgba(250, 192, 219, 0.85)",
    "border-color": "rgba(230, 182, 206, 0.6)",
    "text-color-internal": "#FFF",
  },
  {
    color: "rgba(204, 239, 185, 0.7)",
    "border-color": "rgba(204, 239, 185, 0.5)",
    "text-color-internal": "#FFFFFF",
  },
  {
    color: "rgba(255, 196, 157, 0.8)",
    "border-color": "(280, 196, 157, 0.5)",
    "text-color-internal": "#FFFFFF",
  },
  {
    color: "rgba(252, 248, 157, 0.8)",
    "border-color": "rgba(188, 208, 195, 0.7",
    "text-color-internal": "#FFFFFF",
  },
];
